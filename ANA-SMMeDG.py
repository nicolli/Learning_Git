#Trabalhando com o Arquivo da ANA para Delmiro Gouveia e São Miguel dos Milagres
...
#Passando para índice
chuvas_dg.index=chuvas_dg["Data"]
#Mudando nome do índice
...
#Fazer gráficos
#%%
#chuvas_smm.sort_values(by='Data', ascending=False, inplace=True) #inplace=True (não precisa atribuir valor à variável)
#chuvas_dg.sort_values(by='Data', ascending=False, inplace=True) #inplace=True (não precisa atribuir valor à variável)
